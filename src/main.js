...
async function startApp() {
    ...
    initTapToMove(appState, () => !getUiState().sculptOn && allowTapMove);
...
// Using an async IIFE to handle top-level await for imports if needed,
// though bootstrap.js already handles this pattern.
(async () => {
    try {
        // Bootstrap.js handles the import of this file, so we just run.
        startApp();
    } catch (e) {
